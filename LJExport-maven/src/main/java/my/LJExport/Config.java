...
public class Config
{
    ...
    public static final String Users = "ivanov_petrov";
    ...
    // public static final YYYY_MM LoadTo = new YYYY_MM(2025, 6);
    ...
    public static final int RateLimit_LiveJournal_PageLoad_CoolOff_Interval = 1 * 60 * 1000;
