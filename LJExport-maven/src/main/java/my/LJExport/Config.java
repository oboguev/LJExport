...
public class Config
{
    ...
    public static final String Users = "oboguev,1981dn,1981dn_dn,alex_mashin,alex_vergin,andronic,banguerski_alex,bantaputu,blog_10101,bohemicus,chukcheev,genby,jlm_taurus,kirovtanin,man_with_dogs,sadalskij,salery,takoe_nebo,von_hoffmann,zhenziyou,fritzmorgen";
    ...
    public static final YYYY_MM LoadTill = new YYYY_MM(2025, 9);
    ...
    public static final int WebArchiveOrg_ConcurrenRequests = 5;
    ...
    public static final String LegacyUserAgentFirefox40 = WebRequestHeaders.Firefox40.UserAgent;
    public static final String LegacyUserAgentFirefox43 = WebRequestHeaders.Firefox43.UserAgent;
    public static final String DefaultUserAgent = LegacyUserAgentFirefox43;
    ...
    public static String UserAgentAccept_Download = "image/avif;q=1.0, image/webp;q=0.99, image/png;q=0.98, image/jpeg;q=0.97, image/gif;q=0.96, image/*;q=0.95, "
            +
