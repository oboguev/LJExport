...
public class Config
{
    ...
    public static final String Users = "pioneer_lj";
    ...
    // public static final YYYY_MM LoadSince = new YYYY_MM(2012, 1);
    // public static final YYYY_MM LoadTo = new YYYY_MM(2016, 12);
