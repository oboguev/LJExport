...
public class Config
{
    ...
    public static String Users = "blog_10101";
    ...
    // public static YYYY_MM LoadSince = new YYYY_MM(2010, 6);
    // public static YYYY_MM LoadTo = new YYYY_MM(2010, 6);
    ...
    public static int RateLimitCalendar = 500;
