...
public class Config
{
    ...
    public static final String Users = "schegloff";
    ...
    // public static final YYYY_MM LoadSince = new YYYY_MM(2011, 9);
    // public static final YYYY_MM LoadTo = new YYYY_MM(2011, 9);
