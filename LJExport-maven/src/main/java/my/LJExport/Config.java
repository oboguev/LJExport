...
public class Config
{
    ...
    public static final String Users = "meast_ru";
    ...
    // public static final YYYY_MM LoadSince = new YYYY_MM(2002, 8);
    // public static final YYYY_MM LoadTo = new YYYY_MM(2002, 8);
