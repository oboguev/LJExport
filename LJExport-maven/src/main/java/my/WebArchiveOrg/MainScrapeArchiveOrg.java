...
public class MainScrapeArchiveOrg
{
    ...
    {
        StyleProcessor.processAllHtmlFiles(stylesCatalogDir, null, pagesDir, StyleProcessorAction.TO_LOCAL, null, ShowStyleProgress, false, new HtmlFileBatchProcessingContext());
    }
}
